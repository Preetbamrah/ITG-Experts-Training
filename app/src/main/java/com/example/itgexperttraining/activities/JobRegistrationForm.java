...
public class JobRegistrationForm extends AppCompatActivity {
    TextView textStu, textfath, textadd, textbran, textbat, textcou, textcon, textem, textin;
    Spinner spinnerbathfi, spinnerbathse, spinnerco, spinnerbran, spinnerinter;
    Button buttonreg;
    EditText editTextst, editTextfa, editTextadd, editTextcon, editTextem;
    String[] course = {"+1","+2","B.Tech", "BBA", "MBA", "B.Com", "IT"};
    String[] branch = {"CSE", "EE", "ECE", "ME", "CE"};
    String[] interested = {"Java", "Python", "Android", "Php", "C", "C++", "Networking", "3DS-MAX", "Autocad", "Revit Architecture Structure", "Staad-Pro","Marketing","Digital Marketing","Finance","HR","SEO","Accounting","Tally","Telecom","Robotics","Embedded System","PLC/SCADA","MATLAB","IOT","Solid Work","Catia","CNC","NX CAD/CAM","Other"};
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(JobRegistrationForm.this, android.R.layout.simple_spinner_dropdown_item, years);
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(JobRegistrationForm.this,android.R.layout.simple_spinner_dropdown_item,years);
        spinnerbathfi.setAdapter(adapter);
        arrayAdapter.setDropDownViewResource(R.layout.support_simple_spinner_dropdown_item);
        spinnerbathse.setAdapter(arrayAdapter);

        // course Spinner
        ArrayAdapter<String> courseArray = new ArrayAdapter<String>(JobRegistrationForm.this,android.R.layout.simple_spinner_dropdown_item,course);
        spinnerco.setAdapter(courseArray);

        //Branch Spinner
        ArrayAdapter<String> branchArray = new ArrayAdapter<String>(JobRegistrationForm.this,android.R.layout.simple_spinner_dropdown_item,branch);
        spinnerbran.setAdapter(branchArray);

        //Interested Spinner
        ArrayAdapter<String> interestArray = new ArrayAdapter<String>(JobRegistrationForm.this,android.R.layout.simple_spinner_dropdown_item,interested);
